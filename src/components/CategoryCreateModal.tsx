...
import type { CategoryCreateData } from "@/types/catalog"

const initialForm: CategoryCreateData = {
  name: ""
}
...
export default function CategoryCreateModal() {
  ...
  const [formData, setFormData] = useState<CategoryCreateData>(initialForm)
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setMessage({ type: "success", text: "Categoria creado exitosamente" })
        ...
        setMessage({
          type: "error",
          text: data.message || "Error al crear la categoria",
        })
      }
    } catch {
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Sopas, Bebidas, Postres..."
                />
              </div>
            </div>
